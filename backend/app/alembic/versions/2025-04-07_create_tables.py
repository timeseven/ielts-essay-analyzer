...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "task_type", postgresql.ENUM("task_1", "task_2", name="tasktype"), server_default="task_1", nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            postgresql.ENUM("pending", "invited", "active", "deactivated", name="status"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["client_id", "owner_id"], ["profiles.client_id", "profiles.user_id"], ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.TIMESTAMP(timezone=True), server_default=sa.text("now()"), nullable=False),
        sa.CheckConstraint(
            "coherence_cohesion >= 0 AND coherence_cohesion <= 9", name="check_coherence_cohesion_range"
        ),
